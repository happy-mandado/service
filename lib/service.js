...
class Service {
	...
	closeUserList(userId, listId, products) {
		let savedList = this.db.lists.findByIdAndUserId(listId, userId)
		...
		this.db.products.setAsBoughtAllWithUserIdCreatedBeforeThan(
			userId, products, savedList.closedAt
		);
